...
// node_modules/react-typing-writer-effect/dist/index.es.js
...
function stylis_min(W2) {
  function M2(d2, c3, e3, h, a3) {
    for (var m2 = 0, b2 = 0, v2 = 0, n3 = 0, q2, g2, x2 = 0, K2 = 0, k2, u3 = k2 = q2 = 0, l3 = 0, r3 = 0, I2 = 0, t3 = 0, B3 = e3.length, J2 = B3 - 1, y2, f2 = "", p = "", F3 = "", G3 = "", C2; l3 < B3; ) {
      g2 = e3.charCodeAt(l3);
      l3 === J2 && 0 !== b2 + n3 + v2 + m2 && (0 !== b2 && (g2 = 47 === b2 ? 10 : 47), n3 = v2 = m2 = 0, B3++, J2++);
      if (0 === b2 + n3 + v2 + m2) {
        ...
        switch (g2) {
          case 123:
                      ...
                      a: {
                        for (u3 = l3 + 1; u3 < J2; ++u3) {
                          switch (e3.charCodeAt(u3)) {
                            case 47:
                              if (42 === g2 && 42 === e3.charCodeAt(u3 - 1) && l3 + 2 !== u3) {
                                l3 = u3 + 1;
                                break a;
                              }
                              break;
            ...
            switch (q2) {
              case 64:
                ...
                k2 = M2(c3, r3, k2, g2, a3 + 1);
                t3 = k2.length;
                0 < A && (r3 = X2(O2, f2, I2), C2 = H2(3, k2, r3, c3, D2, z2, t3, g2, a3, h), f2 = r3.join(""), void 0 !== C2 && 0 === (t3 = (k2 = C2.trim()).length) && (g2 = 0, k2 = ""));
                if (0 < t3)
                  switch (g2) {
                    case 115:
                      f2 = f2.replace(da, ea);
                ...
                break;
              default:
                k2 = M2(c3, X2(c3, f2, I2), k2, h, a3 + 1);
            }
            F3 += k2;
            k2 = I2 = r3 = u3 = q2 = 0;
            f2 = "";
          ...
          case 59:
            ...
            if (1 < (t3 = f2.length))
              switch (0 === u3 && (q2 = f2.charCodeAt(0), 45 === q2 || 96 < q2 && 123 > q2) && (t3 = (f2 = f2.replace(" ", ":")).length), 0 < A && void 0 !== (C2 = H2(1, f2, c3, d2, D2, z2, p.length, h, a3, h)) && 0 === (t3 = (f2 = C2.trim()).length) && (f2 = "\0\0"), q2 = f2.charCodeAt(0), g2 = f2.charCodeAt(1), q2) {
                case 0:
                  break;
                case 64:
                  if (105 === g2 || 99 === g2) {
                ...
                default:
                  58 !== f2.charCodeAt(t3 - 1) && (p += P(f2, q2, g2, f2.charCodeAt(2)));
              }
            I2 = r3 = u3 = q2 = 0;
            f2 = "";
            g2 = e3.charCodeAt(++l3);
      ...
      switch (g2) {
        case 13:
        case 10:
          47 === b2 ? b2 = 0 : 0 === 1 + q2 && 107 !== h && 0 < f2.length && (r3 = 1, f2 += "\0");
          0 < A * Y2 && H2(0, f2, c3, d2, D2, z2, p.length, h, a3, h);
          z2 = 1;
          D2++;
          break;
        case 59:
        ...
        default:
          ...
          switch (g2) {
            ...
            case 11:
              ...
              break;
            case 38:
              0 === n3 + b2 + m2 && (r3 = I2 = 1, y2 = "\f" + y2);
              break;
            case 108:
              if (0 === n3 + b2 + m2 + E2 && 0 < u3)
                switch (l3 - u3) {
                  case 2:
                    112 === x2 && 58 === e3.charCodeAt(l3 - 3) && (E2 = x2);
                  case 8:
                    111 === K2 && (E2 = K2);
                }
              break;
            case 58:
              ...
              break;
            case 44:
              0 === b2 + v2 + n3 + m2 && (r3 = 1, y2 += "\r");
              break;
            case 34:
            case 39:
              0 === b2 && (n3 = n3 === g2 ? 0 : 0 === n3 ? g2 : n3);
              break;
            case 91:
              0 === n3 + b2 + v2 && m2++;
              break;
              ...
              if (!(0 < n3 + m2 + v2))
                switch (b2) {
                  case 0:
                    ...
                    break;
                  case 42:
                    47 === g2 && 42 === x2 && t3 + 2 !== l3 && (33 === e3.charCodeAt(t3 + 2) && (p += e3.substring(t3, l3 + 1)), y2 = "", b2 = 0);
                }
          }
          0 === b2 && (f2 += y2);
      }
    ...
    if (0 < t3) {
      r3 = c3;
      if (0 < A && (C2 = H2(2, p, r3, d2, D2, z2, t3, h, a3, h), void 0 !== C2 && 0 === (p = C2).length))
        return G3 + p + F3;
      p = r3.join(",") + "{" + p + "}";
      if (0 !== w2 * E2) {
        2 !== w2 || L2(p, 2) || (E2 = 0);
  ...
  function X2(d2, c3, e3) {
    var h = c3.trim().split(ia);
    c3 = h;
    ...
    switch (m2) {
      ...
      case 1:
        var b2 = 0;
        for (d2 = 0 === m2 ? "" : d2[0] + " "; b2 < a3; ++b2) {
          c3[b2] = Z2(d2, c3[b2], e3).trim();
        }
        break;
      default:
        var v2 = b2 = 0;
        for (c3 = []; b2 < a3; ++b2) {
          for (var n3 = 0; n3 < m2; ++n3) {
            c3[v2++] = Z2(d2[n3] + " ", h[b2], e3).trim();
          }
        }
    }
    return c3;
  }
  function Z2(d2, c3, e3) {
  ...
  function P(d2, c3, e3, h) {
    var a3 = d2 + ";", m2 = 2 * c3 + 3 * e3 + 4 * h;
    if (944 === m2) {
      d2 = a3.indexOf(":", 9) + 1;
    ...
    switch (m2) {
      ...
      case 1e3:
        ...
        c3 = b2.indexOf("-") + 1;
        switch (b2.charCodeAt(0) + b2.charCodeAt(c3)) {
          case 226:
            b2 = a3.replace(G2, "tb");
            break;
          case 232:
      ...
      case 975:
        c3 = (a3 = d2).length - 10;
        b2 = (33 === a3.charCodeAt(c3) ? a3.substring(0, c3) : a3).substring(d2.indexOf(":", 7) + 1).trim();
      ...
      case 953:
        if (true === la.test(d2))
          return 115 === (b2 = d2.substring(d2.indexOf(":") + 1)).charCodeAt(0) ? P(d2.replace("stretch", "fill-available"), c3, e3, h).replace(":fill-available", ":stretch") : a3.replace(b2, "-webkit-" + b2) + a3.replace(b2, "-moz-" + b2.replace("fill-", "")) + a3;
        break;
      case 962:
        if (a3 = "-webkit-" + a3 + (102 === a3.charCodeAt(5) ? "-ms-" + a3 : "") + a3, 211 === e3 + h && 105 === a3.charCodeAt(13) && 0 < a3.indexOf("transform", 10))
          return a3.substring(0, a3.indexOf(";", 27) + 1).replace(ma, "$1-webkit-$2") + a3;
    }
    return a3;
  }
  function L2(d2, c3) {
    var e3 = d2.indexOf(1 === c3 ? ":" : "{"), h = d2.substring(0, 3 !== c3 ? e3 : 10);
    e3 = d2.substring(e3 + 1, d2.length - 1);
    return R2(2 !== c3 ? h : h.replace(na, "$1"), e3, c3);
  }
  function ea(d2, c3) {
    var e3 = P(c3, c3.charCodeAt(0), c3.charCodeAt(1), c3.charCodeAt(2));
    return e3 !== c3 + ";" ? e3.replace(oa, " or ($1)").substring(4) : "(" + c3 + ")";
  }
  function H2(d2, c3, e3, h, a3, m2, b2, v2, n3, q2) {
    for (var g2 = 0, x2 = c3, w3; g2 < A; ++g2) {
    ...
    switch (d2) {
      ...
      default:
        if ("function" === typeof d2)
          ...
          for (var c3 = 0, e3 = d2.length; c3 < e3; ++c3) {
            T2(d2[c3]);
          }
        else
          Y2 = !!d2 | 0;
  ...
  function B2(d2, c3) {
    ...
    e3 = [V2];
    if (0 < A) {
      var h = H2(-1, c3, e3, e3, D2, z2, 0, 0, 0, 0);
      void 0 !== h && "string" === typeof h && (c3 = h);
    }
    var a3 = M2(O2, e3, c3, 0, 0);
    0 < A && (h = H2(-2, a3, e3, e3, D2, z2, a3.length, 0, 0, 0), void 0 !== h && (a3 = h));
    V2 = "";
    E2 = 0;
    z2 = D2 = 1;
    return a3;
...
var v = function(e3, t3) {
  for (var n3 = [e3[0]], r3 = 0, o2 = t3.length; r3 < o2; r3 += 1)
...
var j = function() {
  ...
  return t3.indexOfGroup = function(e4) {
    ...
    for (var i2 = this.indexOfGroup(e4 + 1), a3 = 0, c3 = t4.length; a3 < c3; a3++)
      this.tag.insertRule(i2, t4[a3]) && (this.groupSizes[e4]++, i2++);
...
var L = function(e3, t3, n3) {
  for (var r3, o2 = n3.split(","), s3 = 0, i2 = o2.length; s3 < i2; s3++)
...
var q = function(e3) {
  var t3 = document.head, n3 = e3 || t3, r3 = document.createElement("style"), o2 = function(e4) {
  ...
  var i2 = Y();
  return i2 && r3.setAttribute("nonce", i2), n3.insertBefore(r3, s3), r3;
};
var H = function() {
  function e3(e4) {
...
var X = function() {
  ...
  return t3.reconstructWithOptions = function(t4, n3) {
    ...
    return this.tag || (this.tag = (n3 = (t4 = this.options).isServer, r3 = t4.useCSSOMInjection, o2 = t4.target, e4 = n3 ? new W(o2) : r3 ? new H(o2) : new $(o2), new j(e4)));
    var e4, t4, n3, r3, o2;
    ...
    return function(e4) {
      for (var t4 = e4.getTag(), n3 = t4.length, r3 = "", o2 = 0; o2 < n3; o2++) {
        var s3 = B(o2);
        if (void 0 !== s3) {
          var i2 = e4.names.get(s3), a3 = t4.getGroup(o2);
          if (i2 && a3 && i2.size) {
            var c3 = N + ".g" + o2 + '[id="' + s3 + '"]', u3 = "";
            void 0 !== i2 && i2.forEach(function(e5) {
              e5.length > 0 && (u3 += e5 + ",");
...
var oe = function() {
  ...
  return e3.prototype.generateAndInjectStyles = function(e4, t3, n3) {
    ...
    if (this.baseStyle && o2.push(this.baseStyle.generateAndInjectStyles(e4, t3, n3)), this.isStatic && !n3.hash)
      if (this.staticRulesId && t3.hasNameForId(r3, this.staticRulesId))
        o2.push(this.staticRulesId);
      else {
        var s3 = _e(this.rules, e4, t3, n3).join(""), i2 = Q(ee(this.baseHash, s3) >>> 0);
        if (!t3.hasNameForId(r3, i2)) {
          var a3 = n3(s3, "." + i2, void 0, r3);
          t3.insertRules(r3, i2, a3);
        }
        o2.push(i2), this.staticRulesId = i2;
      }
    else {
      for (var c3 = this.rules.length, u3 = ee(this.baseHash, n3.hash), l3 = "", d2 = 0; d2 < c3; d2++) {
        var h = this.rules[d2];
        if ("string" == typeof h)
          l3 += h, u3 = ee(u3, h + d2);
        else if (h) {
          var p = _e(h, e4, t3, n3), f2 = Array.isArray(p) ? p.join("") : p;
          u3 = ee(u3, f2 + d2), l3 += f2;
        }
      }
      if (l3) {
        var m2 = Q(u3 >>> 0);
        if (!t3.hasNameForId(r3, m2)) {
          var y2 = n3(l3, "." + m2, void 0, r3);
...
var ie = [":", "[", ".", "#"];
function ae(e3) {
  var t3, n3, r3, o2, s3 = void 0 === e3 ? w : e3, i2 = s3.options, a3 = void 0 === i2 ? w : i2, c3 = s3.plugins, u3 = void 0 === c3 ? S : c3, l3 = new stylis_browser_esm_default(a3), d2 = [], p = function(e4) {
    function t4(t5) {
      if (t5)
        try {
          e4(t5 + "}");
    ...
    return function(n4, r4, o3, s4, i3, a4, c4, u4, l4, d3) {
      switch (n4) {
        case 1:
    ...
    return 0 === r4 && -1 !== ie.indexOf(s4[n3.length]) || s4.match(o2) ? e4 : "." + t3;
  };
  function m2(e4, s4, i3, a4) {
    void 0 === a4 && (a4 = "&");
    var c4 = e4.replace(se, ""), u4 = s4 && i3 ? i3 + " " + s4 + " { " + c4 + " }" : c4;
    return t3 = a4, n3 = s4, r3 = new RegExp("\\" + n3 + "\\b", "g"), o2 = new RegExp("(\\" + n3 + "\\b){2,}"), l3(i3 || !s4 ? "" : s4, u4);
  }
...
function _e(e3, n3, r3, o2) {
  if (Array.isArray(e3)) {
    for (var s3, i2 = [], a3 = 0, c3 = e3.length; a3 < c3; a3 += 1)
      "" !== (s3 = _e(e3[a3], n3, r3, o2)) && (Array.isArray(s3) ? i2.push.apply(i2, s3) : i2.push(s3));
    return i2;
  }
  if (be(e3))
    return "";
  ...
  var l3;
  return e3 instanceof ye ? r3 ? (e3.inject(r3, o2), e3.getName(o2)) : e3 : g(e3) ? function e4(t3, n4) {
    var r4, o3, s4 = [];
    for (var i3 in t3)
      t3.hasOwnProperty(i3) && !be(t3[i3]) && (Array.isArray(t3[i3]) && t3[i3].isCss || E(t3[i3]) ? s4.push(Ee(i3) + ":", t3[i3], ";") : g(t3[i3]) ? s4.push.apply(s4, e4(t3[i3], i3)) : s4.push(Ee(i3) + ": " + (r4 = i3, null == (o3 = t3[i3]) || "boolean" == typeof o3 || "" === o3 ? "" : "number" != typeof o3 || 0 === o3 || r4 in unitless_browser_esm_default || r4.startsWith("--") ? String(o3).trim() : o3 + "px") + ";"));
...
function Ye(e3, t3, n3) {
  var o2 = _(e3), i2 = !xe(e3), a3 = t3.attrs, c3 = void 0 === a3 ? S : a3, l3 = t3.componentId, d2 = void 0 === l3 ? function(e4, t4) {
    var n4 = "string" != typeof e4 ? "sc" : je(e4);
    Fe[n4] = (Fe[n4] || 0) + 1;
    var r3 = n4 + "-" + Te("5.3.11" + n4 + Fe[n4]);
    return t4 ? t4 + "-" + r3 : r3;
  }(t3.displayName, t3.parentComponentId) : l3, h = t3.displayName, p = void 0 === h ? function(e4) {
    return xe(e4) ? "styled." + e4 : "Styled(" + b(e4) + ")";
  }(e3) : h, v2 = t3.displayName && t3.componentId ? je(t3.displayName) + "-" + t3.componentId : t3.componentId || d2, g2 = o2 && e3.attrs ? Array.prototype.concat(e3.attrs, c3).filter(Boolean) : c3, N2 = t3.shouldForwardProp;
  o2 && e3.shouldForwardProp && (N2 = t3.shouldForwardProp ? function(n4, r3, o3) {
    return e3.shouldForwardProp(n4, r3, o3) && t3.shouldForwardProp(n4, r3, o3);
  } : e3.shouldForwardProp);
  var A, C2 = new oe(n3, v2, o2 ? e3.componentStyle : void 0), I2 = C2.isStatic && 0 === c3.length, P = function(e4, t4) {
    return function(e5, t5, n4, r3) {
      var o3 = e5.attrs, i3 = e5.componentStyle, a4 = e5.defaultProps, c4 = e5.foldedComponentIds, l4 = e5.shouldForwardProp, d3 = e5.styledComponentId, h2 = e5.target, p2 = function(e6, t6, n5) {
        void 0 === e6 && (e6 = w);
        var r4 = y({}, t6, { theme: e6 }), o4 = {};
        return n5.forEach(function(e7) {
          var t7, n6, s3, i4 = e7;
          for (t7 in E(i4) && (i4 = i4(r4)), i4)
            r4[t7] = o4[t7] = "className" === t7 ? (n6 = o4[t7], s3 = i4[t7], n6 && s3 ? n6 + " " + s3 : n6 || s3) : i4[t7];
        }), [r4, o4];
      }(Oe(t5, (0, import_react.useContext)(Me), a4) || w, t5, o3), m2 = p2[0], v3 = p2[1], g3 = function(e6, t6, n5, r4) {
        var o4 = pe(), s3 = fe(), i4 = t6 ? e6.generateAndInjectStyles(w, o4, s3) : e6.generateAndInjectStyles(n5, o4, s3);
        return !t6 && r4 && r4(i4), i4;
      }(i3, r3, m2, true ? e5.warnTooManyClasses : void 0), S2 = n4, b2 = v3.$as || t5.$as || v3.as || t5.as || h2, _2 = xe(b2), N3 = v3 !== t5 ? y({}, t5, {}, v3) : t5, A2 = {};
      for (var C3 in N3)
        "$" !== C3[0] && "as" !== C3 && ("forwardedAs" === C3 ? A2.as = N3[C3] : (l4 ? l4(C3, isPropValid, b2) : !_2 || isPropValid(C3)) && (A2[C3] = N3[C3]));
      return t5.style && v3.style !== t5.style && (A2.style = y({}, t5.style, {}, v3.style)), A2.className = Array.prototype.concat(c4, d3, g3 !== d3 ? g3 : null, t5.className, v3.className).filter(Boolean).join(" "), A2.ref = S2, (0, import_react.createElement)(b2, A2);
    }(A, e4, t4, I2);
  };
  return P.displayName = p, (A = import_react.default.forwardRef(P)).attrs = g2, A.componentStyle = C2, A.displayName = p, A.shouldForwardProp = N2, A.foldedComponentIds = o2 ? Array.prototype.concat(e3.foldedComponentIds, e3.styledComponentId) : S, A.styledComponentId = v2, A.target = o2 ? e3.target : e3, A.withComponent = function(e4) {
    var r3 = t3.componentId, o3 = function(e5, t4) {
      if (null == e5)
        return {};
      var n4, r4, o4 = {}, s4 = Object.keys(e5);
      for (r4 = 0; r4 < s4.length; r4++)
        n4 = s4[r4], t4.indexOf(n4) >= 0 || (o4[n4] = e5[n4]);
      return o4;
    }(t3, ["componentId"]), s3 = r3 && r3 + "-" + (xe(e4) ? e4 : je(b(e4)));
    return Ye(e4, y({}, o3, { attrs: g2, componentId: s3 }), n3);
  }, Object.defineProperty(A, "defaultProps", { get: function() {
    return this._foldedDefaultProps;
  }, set: function(t4) {
    this._foldedDefaultProps = o2 ? ze({}, e3.defaultProps, t4) : t4;
  } }), Pe(p, v2), A.warnTooManyClasses = function(e4, t4) {
    var n4 = {}, r3 = false;
    return function(o3) {
  ...
  } }), i2 && (0, import_hoist_non_react_statics.default)(A, e3, { attrs: true, componentStyle: true, displayName: true, foldedComponentIds: true, shouldForwardProp: true, styledComponentId: true, target: true, withComponent: true }), A;
}
var qe = function(e3) {
  return function e4(t3, r3, o2) {
    ...
    return s3.withConfig = function(n3) {
      return e4(t3, r3, y({}, o2, {}, n3));
    }, s3.attrs = function(n3) {
      return e4(t3, r3, y({}, o2, { attrs: Array.prototype.concat(o2.attrs, n3).filter(Boolean) }));
    }, s3;
  }(Ye, e3);
};
...
var He = function() {
  ...
  return t3.createStyles = function(e4, t4, n3, r3) {
    var o2 = r3(_e(this.rules, t4, n3, r3).join(""), ""), s3 = this.componentId + e4;
...
function We(e3) {
  ...
  for (var t3 = arguments.length, n3 = new Array(t3 > 1 ? t3 - 1 : 0), r3 = 1; r3 < t3; r3++)
    n3[r3 - 1] = arguments[r3];
  var o2 = Ae.apply(void 0, [e3].concat(n3)).join(""), s3 = Te(o2);
  return new ye(s3, o2);
}
var Ue = function() {
  function e3() {
    ...
    this._emitSheetCSS = function() {
      ...
      if (e4.sealed)
        return D(2);
      var n3 = ((t4 = {})[N] = "", t4["data-styled-version"] = "5.3.11", t4.dangerouslySetInnerHTML = { __html: e4.instance.toString() }, t4), o2 = Y();
...
// node_modules/react-typing-writer-effect/dist/index.es.js
function r2(n3, t3) {
  return Object.defineProperty ? Object.defineProperty(n3, "raw", { value: t3 }) : n3.raw = t3, n3;
}
var a2;
var l2;
var c2 = We(a2 || (a2 = r2(["\n    100% { color: white; }\n"], ["\n    100% { color: white; }\n"])));
var s2 = styled_components_browser_esm_default.div(l2 || (l2 = r2(["\n  font-size: ", "px;\n  &:after {\n    display: inline-block;\n    height: ", 'px;\n    margin-left: 3px;\n    border-right: 3px solid;\n    content: "";\n    animation-name: ', ";\n    animation-duration: 0.5s;\n    animation-iteration-count: infinite;\n  }\n"], ["\n  font-size: ", "px;\n  &:after {\n    display: inline-block;\n    height: ", 'px;\n    margin-left: 3px;\n    border-right: 3px solid;\n    content: "";\n    animation-name: ', ";\n    animation-duration: 0.5s;\n    animation-iteration-count: infinite;\n  }\n"])), function(n3) {
  return n3.size;
}, function(n3) {
  return 0.7 * n3.size;
}, c2);
var u2 = function(i2) {
  var o2 = i2.text, r3 = i2.size, a3 = void 0 === r3 ? 100 : r3, l3 = i2.speed, c3 = void 0 === l3 ? 100 : l3, u3 = i2.handleFinish, f2 = (0, import_react2.useState)(""), h = f2[0], m2 = f2[1], d2 = (0, import_react2.useState)(0), g2 = d2[0], p = d2[1];
  return (0, import_react2.useEffect)(function() {
    0 === g2 ? (o2.length >= 0 && h.length < o2.length && (0 !== h.length ? setTimeout(function() {
      m2(h + o2[h.length]);
    }, c3) : setTimeout(function() {
      m2(o2[0]);
    }, c3)), h.length === o2.length && setTimeout(function() {
      p(1);
    }, c3)) : (o2.length > 0 && h.length > 0 && setTimeout(function() {
      m2(h.slice(0, h.length - 1));
    }, c3), 0 === h.length && (p(0), u3()));
  }, [h, o2, c3, g2, u3]), import_react2.default.createElement(s2, { size: a3 }, h);
};
function f(i2) {
  var o2 = i2.textArray, r3 = i2.speed, a3 = i2.size, l3 = (0, import_react2.useState)(false), c3 = l3[0], s3 = l3[1], f2 = (0, import_react2.useState)(0), h = f2[0], m2 = f2[1];
  return (0, import_react2.useEffect)(function() {
    c3 && (h < o2.length - 1 ? (m2(h + 1), s3(false)) : h === o2.length - 1 && (m2(0), s3(false)));
  }, [c3, h]), import_react2.default.createElement(u2, { text: o2[h], speed: r3, size: a3, handleFinish: function() {
    s3(true);
  } });
}
export {
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=react-typing-writer-effect.js.map
