    ...
    <div className='w-full py-[10rem] px-4 bg-white'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
          <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
              ...
              <button className='bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3 hover:bg-black hover:text-white'>Start Trial</button>
          </div>
          ...
          <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
              ...
              <h2 className='text-2xl font-bold text-center py-8'>Thruple User</h2>
              <p className='text-center text-4xl font-bold'>$80</p>
              <div className='text-center font-medium'>
